...
public:
    ...
    void AddInspectionDataWithStats(InspectionInfoItem data, QList<DefectInfoItem> defectInfos);
private:
...
signals:
    ...
    void addInspectionDataWithStats_Signal(const InspectionInfoItem& data, const QVariantList& defectInfos);
